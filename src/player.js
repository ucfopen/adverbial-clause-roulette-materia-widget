(function() {
	Namespace('Roulette').Engine = (function() {
		...
		start = function(instance, qset, version) {
			...
			// Simplified some logic here by removing request for questions.json:
			// For the demo, qset is pulled from demo.json (identical to questions.json)
			// For instances, creator makes request for questions.json, then saves qset like a normal widget
			// What the shit is "wibbleWobble" anyways
